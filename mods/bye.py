...
async def cmd_function(msg: Message, *args):
    ...
    message = f'byeeee {mention}! Thank you for hanging out. see you tomorrow lisare1Heart '
...
async def cmd_function(msg: Message, *args):
    ...
    message = f'welcome welcome {mention}! thank you for popping in. make yourself at home lisare1Heart '
